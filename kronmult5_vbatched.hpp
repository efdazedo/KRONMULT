...
kronmult5_vbatched(int const m1, int const n1, int const m2, int const n2,
                   int const m3, int const n3, int const m4, int const n4,
                   int const m5, int const n5, T const *const Aarray_[],
                   T *pX_[], T *pY_[], T *W_, size_t const Wcapcity,
