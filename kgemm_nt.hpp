...
kgemm_nt2(int const mm, int const nn, int const kk, T const alpha_in,
...
template<typename T>
DEVICE_FUNCTION void
kgemm_nt(int const mm, int const nn, int const kk, T const alpha_in,
         T const *const A_, int const ldA, T const *const B_, int const ldB,
         T const beta_in, T *C_, int const ldC)
{
  kgemm_nt2<T, T>(mm, nn, kk, alpha_in, A_, ldA, B_, ldB, beta_in, C_, ldC);
}

template<>
DEVICE_FUNCTION void
kgemm_nt(int const mm, int const nn, int const kk, float const alpha_in,
         float const *const A_, int const ldA, float const *const B_,
         int const ldB, float const beta_in, float *C_, int const ldC)
{
  kgemm_nt2<float, double>(mm, nn, kk, alpha_in, A_, ldA, B_, ldB, beta_in, C_,
                           ldC);
}
